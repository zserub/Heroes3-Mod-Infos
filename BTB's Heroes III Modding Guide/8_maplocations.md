...
------------------------	------------------------	------------------------
    TEMPLE (WEEKDAYS)		    TEMPLE (SUNDAYS)		       FAIRY RING
------------------------	------------------------	------------------------
0A5F10: 1A = Morale		0A5EDC: 1A = Morale		0A8C22:	1B = Luck
0A5F29: ""			0A5EF6: ""			0A8C2A:	""
0A5F1F: FE C1 (INC)		0A5EED: +2			0A8C26:	FE C0 (INC)
0A5F45: 0E = MoraleUp		0A5F0C: 0E = MoraleUp		0A8BC1: 0B = LuckUp
...
------------------------	-------------------------	------------------------
    IDOL (WEEKDAYS)		     IDOL (SUNDAYS)		       RALLY FLAG
------------------------	-------------------------	------------------------
0A102A: 1B = Luck		0A0FC6: 1B = Luck		0A41FE: 1A = Morale
0A103A: ""			0A0FDC: ""			0A4214: ""
0A1036: FE C1 (INC)		0A0FD8: FE C2 (INC)		0A4210: FE C0 (INC)
0A101A: 0B = LuckUp		0A0FB6: 0B = LuckUp		0A41A6: 0E = Morale

0A1073: 1A = Morale		0A0FCC: 1A = Morale		0A4204: 1B = Luck
0A1086: ""			0A0FE2: ""			0A4225: ""
0A107F: FE C1 (INC)		0A0FDA: FE C1 (INC)		0A4212: FE C2 (INC)
0A1063: 0E = MoraleUp		0A0FAC: 0E = MoraleUp		0A419C: 0B = LuckUp
...
instead NOP out the jump at 0A0F90 (75 60 -> 90 90).
		...
		------------------------	------------------------
		  FOUNTAIN OF FORTUNE		       SWAN POND
		------------------------	------------------------
		0A21F3: 1B = Luck		0A88C1: 1B = Luck
		0A2201: ""			0A88D6:	""
		0A21FD: 02 C8 (Add "X")		0A88CA: 02 = +2
		0A2146:	0B = LuckUp		0A88FA: 0B = LuckUp
		0A214A: 0D = LuckDown		0A88CB: Movement to 0
...
------------------------	------------------------	------------------------
     WATERING HOLE		   FOUNTAIN OF YOUTH		         OASIS
------------------------	------------------------	------------------------
0A7BDA:	1A = Morale		0A232C:	1A = Morale		0A39F0:	1A = Morale
0A7BF1:	""			0A2343: ""			0A3A04:	""
0A7BE4:	FE C0 (INC)		0A2336: FE C0 (INC)		0A3A00: FE C3 (INC)
0A7B87:	0E = MoraleUp		0A22D9:	0E = MoraleUp		0A3982:	0E = MoraleUp
0A7BF6:	+400 movement		0A2348:	+400 movement		0A39F5:	+800 movement
...
and then changing 0E (this is the "Morale Up" graphic in the text box) to FF.
		...
		------------------------	------------------------
		          BUOY			        MERMAID
		------------------------	------------------------
		0A85BE: 1A = Morale		0A93DA: 1B = Luck
		0A85CE: ""			0A93E2: ""
		0A85C6: FE C2 (INC)		0A93E0: FE C0 (INC)
		0A863A:	0E = MoraleUp		0A937A: 0B = LuckUp
...
------------------------	------------------------	------------------------
        PYRAMID			     SHIPS & CRYPTS		      WARRIOR TOMB
------------------------	------------------------	------------------------
0A3F84: 1B = Luck		0AC23A: 1A = Morale		0A7A2C: 1A = Morale
0A3F8C: ""			0AC242: ""			0A7A34: ""
0A3F89: (DEC*)			0AC23E: FE C8 (DEC)		0A7A31: FD (-3)
0A3F51: 0D = LuckDown		0AC213: 10 = MoraleDown		0A79E1: 10 = MoraleDown
0A3F5B: 0D ""			------------------------	0A79EC: ""
------------------------	------------------------	0A79F6:	""
...
choice of attribute for a tuition fee. Let's look into making them a little more effective:
	...
	School of War			School of Magic
	---------------------		------------------------
	0A786C: FE C0 > 04 XX		0A31CD: FE C3 > 80 C3 XX
	0A77C3: XX			0A316A: XX
	0A77CD: XX			0A3174: XX
	--------------------------	--------------------------
	0A774F: E8 03 (1,000 gold)	0A30EF: E8 03 (1,000 gold)
	0A788F: 18 FC (-1,000 gold)	0A31F3: 18 FC (-1,000 gold)
...
To this end, here are two basic templates to work from:
		...
		MULTIPLY/DIVIDE				  MULTIPLY/ADD
	--------------------------------	--------------------------------
	8B 45 FC	mov eax,[ebp-04]	8B 45 FC	mov eax,[ebp-04]
	6B C0 XX	imul eax,(XX)		01 C0		add eax,eax
	C1 F8 XX	sar eax,(XX)		05 XX XX XX XX	add eax,(XXXX)
	89 45 FC	mov [ebp-04],eax	89 45 FC	mov [ebp-04],eax
	90		nop			-
